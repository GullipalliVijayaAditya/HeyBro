package com.example.aditya.heybro.ui.activities;
...
import com.example.aditya.heybro.adapters.DrawerAdapter;
import com.example.aditya.heybro.feature_ai.activities.AddQuestion;
import com.example.aditya.heybro.feature_ai.activities.AnswersActivity;
import com.example.aditya.heybro.feature_ai.activities.ResultActivity;
import com.example.aditya.heybro.feature_ai.adapter.RecentsAdapter;
import com.example.aditya.heybro.feature_ai.models.Recents;
import com.example.aditya.heybro.feature_ai.utils.RecentsDatabase;
import com.example.aditya.heybro.models.DrawerItem;
import com.example.aditya.heybro.models.SimpleItem;
import com.example.aditya.heybro.ui.activities.account.LoginActivity;
import com.example.aditya.heybro.ui.activities.account.UpdateAvailable;
import com.example.aditya.heybro.ui.activities.friends.FriendProfile;
import com.example.aditya.heybro.ui.activities.notification.NotificationActivity;
import com.example.aditya.heybro.ui.activities.notification.NotificationImage;
import com.example.aditya.heybro.ui.activities.notification.NotificationImageReply;
import com.example.aditya.heybro.ui.activities.notification.NotificationReplyActivity;
import com.example.aditya.heybro.ui.activities.post.CommentsActivity;
import com.example.aditya.heybro.ui.activities.post.PostImage;
import com.example.aditya.heybro.ui.activities.post.PostText;
import com.example.aditya.heybro.ui.activities.post.SinglePostView;
import com.example.aditya.heybro.ui.fragment.About;
import com.example.aditya.heybro.ui.fragment.Dashboard;
import com.example.aditya.heybro.ui.fragment.FlashMessage;
import com.example.aditya.heybro.ui.fragment.Forum;
import com.example.aditya.heybro.ui.fragment.FriendsFragment;
import com.example.aditya.heybro.ui.fragment.ProfileFragment;
import com.example.aditya.heybro.utils.Config;
import com.example.aditya.heybro.utils.NetworkUtil;
import com.example.aditya.heybro.utils.database.UserHelper;
...
public class MainActivity extends AppCompatActivity implements DrawerAdapter.OnItemSelectedListener {
    ...
    public void showDialog() {
        ...
        new BottomDialog.Builder(this)
                ...
                .setPositiveBackgroundColorResource(R.color.colorAccentone)
                .setCancelable(true)
    ...
    private DrawerItem createItemFor(int position) {
        return new SimpleItem(screenIcons[position], screenTitles[position])
                ...
                .withSelectedIconTint(color(R.color.colorAccentone))
                .withSelectedTextTint(color(R.color.colorAccentone));
    }
        ...
        mRegistrationBroadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (intent.getAction().equals(Config.PUSH_NOTIFICATION)) {
                    ...
                    switch (click_action) {
                        case "com.example.aditya.heybro.TARGETNOTIFICATION":
                            ...
                            break;
                        case "com.example.aditya.heybro.TARGETNOTIFICATIONREPLY":
                            ...
                            break;
                        case "com.example.aditya.heybro.TARGETNOTIFICATION_IMAGE":
                            ...
                            break;
                        case "com.example.aditya.heybro.TARGETNOTIFICATIONREPLY_IMAGE":
                            ...
                            break;
                        case "com.example.aditya.heybro.TARGET_FRIENDREQUEST":
                            ...
                            break;
                        case "com.example.aditya.heybro.TARGET_COMMENT":
                            ...
                            break;
                        case "com.example.aditya.heybro.TARGET_UPDATE":
                            ...
                            break;
                        case "com.example.aditya.heybro.TARGET_LIKE":
                            ...
                            break;
                        case "com.example.aditya.heybro.TARGET_FORUM":
