package com.example.aditya.heybro.ui.activities.notification;
...
import com.example.aditya.heybro.ui.activities.friends.SendActivity;
...
public class NotificationImageReply extends AppCompatActivity {
    ...
    private void updateReadStatus() {
        ...
        if (!read) {
            ...
            mFirestore.collection("Users/" + current_id + "/Notifications_reply_image")
