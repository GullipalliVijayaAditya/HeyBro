    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        email.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                email.putExtra(Intent.EXTRA_EMAIL, new String[]{"vijayaaditya1996@gmail.com"});
                email.putExtra(Intent.EXTRA_SUBJECT, "Sent from heybro ( " + Build.BRAND + "(" + Build.VERSION.SDK_INT + ") )");
        ...
        website.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String url = "http://gullipallivijayaaditya.github.io/lvstore";
        ...
        instagram.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String url = "https://www.instagram.com/gullipallivijayaaditya";
                Intent i = new Intent(Intent.ACTION_VIEW);
                i.setData(Uri.parse(url));
                startActivity(i);
        ...
        github.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String url = "https://github.com/gullipallivijayaaditya/heybro";
                Intent i = new Intent(Intent.ACTION_VIEW);
                i.setData(Uri.parse(url));
                startActivity(i);
